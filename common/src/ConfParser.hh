...
{
public:
  typedef boost::spirit::line_pos_iterator<string::const_iterator> Iterator;
...
public:
  ...
  struct section
  {
    string             m_name;
    vector<property>   m_properties;
    vector<subsection> m_subsections;
  };
...
public:
  struct config_grammar : boost::spirit::qi::grammar<Iterator, sections(), Skipper>
  {
  public:
    config_grammar(void);
...
BOOST_FUSION_ADAPT_STRUCT(xtd::ConfigParser2::property,
                          (std::string, m_name)
                          (std::string, m_value));


BOOST_FUSION_ADAPT_STRUCT(xtd::ConfigParser2::subsection,
                          (std::string,                 m_name)
                          (std::vector<xtd::ConfigParser2::property>, m_properties));

BOOST_FUSION_ADAPT_STRUCT(xtd::ConfigParser2::section,
                          (std::string,                   m_name)
                          (std::vector<xtd::ConfigParser2::property>,   m_properties)
                          (std::vector<xtd::ConfigParser2::subsection>, m_subsections));

BOOST_FUSION_ADAPT_STRUCT(xtd::ConfigParser2::sections,
                          (std::vector<xtd::ConfigParser2::section>, m_sections));
