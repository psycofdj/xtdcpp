...
// ----------------------------------------------------------------------------
#ifndef __BOOST_PROPERTY_TREE_DETAIL_JSON_PARSER_WRITE_HPP_INCLUDED
#define __BOOST_PROPERTY_TREE_DETAIL_JSON_PARSER_WRITE_HPP_INCLUDED
...
std::basic_string<Ch> create_escapes(const std::basic_string<Ch> &s)
{
  ...
  while (b != e)
  {
    ...
    else
    {
      ...
      // unsigned char u = static_cast<unsigned char>(*b);
      // int d3 = u / 16; u -= d3 * 16;
      // int d4 = u;
      // result += Ch('\\');
      // result += Ch('x');
