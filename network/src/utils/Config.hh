#ifndef NETWORK_UTILS_CONFIG_HH_
# define NETWORK_UTILS_CONFIG_HH_
...
enum class option  : uint32_t { nodelay = 1, reuseaddr = 2, keepalive = 4, linger = 8, compress = 64 };
enum class codec   : uint32_t { zlib = 1,    gzip = 2,      bzip2 = 3 };
